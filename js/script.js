...
function afterAngle(angle) {
  console.log(angle);
  document.getElementById("measurementInfo").innerHTML = `Angle : ${angle}`;
}

function afterPoint(point) {
  console.log(point);
  document.getElementById("measurementInfo").innerHTML = `Point :  ${point}`;
}
...
function onClickLayerBtn(e) {
  ...
  if (layerList.style.display == "block") {
    layers.setAttribute("src", "../icons/left_menu/layer.png");
...
const osnapBox = document.querySelector(".osnaps img");
osnapBox.addEventListener("click", onClickOsnapBtn);

function onClickOsnapBtn(e) {
  console.log(e);
  const parent = osnapBox.parentNode;
  const osnapVisible = document.querySelector("#osnaps-wrap");

  if (osnapVisible.style.display == "block") {
    osnapBox.setAttribute("src", "../icons/left_menu/osnap.png");
    parent.style.backgroundColor = "transparent";
    osnapVisible.style.display = "none";
  } else {
    osnapBox.setAttribute("src", "../icons/left_menu_click/osnap.png");
    parent.style.backgroundColor = "#3c4259";
    osnapVisible.style.display = "block";
  }
}
